...
const MobileContactsList = dynamic(() => import('@/components/mobile/MobileContactsList'), {
  ssr: false,
  loading: () => (
...
const ReminderSidebar = dynamic(() => import('@/components/crm/ReminderSidebar'), {
  ssr: false,
})
...
export default function ContactsClient({ initialContacts = [], userId }: Props) {
  const router = useRouter()
  const device = useDevice()
  const supabase = createClientComponent()

  const [contacts, setContacts] = useState<ScannedContact[]>(initialContacts)
