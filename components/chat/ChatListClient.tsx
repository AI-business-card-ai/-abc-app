...
export default function ChatListClient({ initialContacts = [] }: Props) {
  const router = useRouter()
  const [contacts] = useState<ScannedContact[]>(initialContacts)
          ...
          >
            <div
              style={{
                ...
                height: '64px',
                borderRadius: '50%',
                background: 'linear-gradient(135deg, rgba(240,25,125,0.2), rgba(0,212,212,0.2))',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: '28px',
